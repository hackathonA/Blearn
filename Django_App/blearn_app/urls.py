...
from .views import signupfunc, loginfunc, logoutfunc, ContentCreate, ContentList, ContentDetail, ContentUpdate, ContentDelete, ContentList2, ContentList3, ContentList4
